    ...
    extend: {
      colors: {
        ...
        wl: {
          ...
          "accent-ink": "var(--wl-accent-ink)",
          "accent-press": "var(--wl-accent-press)",
          surface: "var(--wl-surface)",
          "surface-2": "var(--wl-surface-2)",
          "surface-3": "var(--wl-surface-3)",
          "surface-hi": "var(--wl-surface-hi)",
          "surface-solid": "var(--wl-surface-solid)",
          border: "var(--wl-border)",
          "border-2": "var(--wl-border-2)",
          "border-3": "var(--wl-border-3)",
          text: "var(--wl-text)",
          "text-2": "var(--wl-text-2)",
          "text-3": "var(--wl-text-3)",
          deep: "var(--wl-deep)",
          "deep-soft": "var(--wl-deep-soft)",
          pos: "var(--wl-pos)",
          neg: "var(--wl-neg)",
          warn: "var(--wl-warn)",
        },
